...
# membuat dictionary
dict = {
    "nama"      : "Azzayana Risnanda",
    "NIM"      : 24241087,
    "Prodi"     : "Pendidikan Teknologi Informasi",
    "mat_kul"    : ['Algoritma dan Pemrograman', 'Struktur Data', 'PBO'],
    "status"    : True,
    "sosmed"    : {
        "Github"    : "@AzzayanaRisnanda11",
        "twiter"    : '_',
        "instagram" : '@Azzayana_R'
    }
}
...
for i in range(jumlah):
    ...
    data_mahasiswa["22001"] = {"nama": "Azza", "jurusan": "TI"}
print("\nCari data mahasiswa")
